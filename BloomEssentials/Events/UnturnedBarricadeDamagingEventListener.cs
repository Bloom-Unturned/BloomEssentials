...
namespace BloomEssentials.Events
{
    ...
    public class UnturnedBarricadeDamagingEventListener : IEventListener<UnturnedBarricadeDamagingEvent>
    {
        private readonly IUnturnedUserDirectory _userDirectory;
        private readonly ICommandExecutor _commandExecutor;
        private readonly IConfiguration m_Configuration;
        public UnturnedBarricadeDamagingEventListener(IUnturnedUserDirectory userDirectory,
